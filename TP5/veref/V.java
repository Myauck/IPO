...
//         vrai( verifModMethod( vMe, "public", "static final" ), "*" );
    ...
    public static void verifOverrideDebug( String pFil, String pType, String pMet, boolean pDebug )
    {
        ...
        try {
          ...
          error( "[Override] Code source de "+pFil+" non analysable : " + pE + " (line " + vCpt + ")" );
        } // t/c
    } // verifOverrideDebug(...)
...
//        System.out.println(System.getProperty("user.dir"));
        ...
        try {
          ...
          error( "[Final1Type] code source de "+pFil+" non analysable : " + pE );
        } // t/c
    } // verifFinal1Type(...)
    ...
    public static void verifParamP1Type( String pFil, String pMet, String pType ) // un seul parametre
    {
        ...
        try {
          ...
          error( "[ParamP1Type] code source de "+pFil+" non analysable : " + pE );
        } // t/c
    } // verifParamP1Type(...)
    ...
    public static void verifParamPNType( String pFil, String pMet, String pType, int pN ) // Neme parametre
    {
        ...
        try {
          ...
          error( "[ParamPNType] code source de "+pFil+" non analysable : " + pE );
        } // t/c
    } // verifParamPNType(....)
...
//                 failIfNot( "$a $c n'est pas une sorte de "+pCla+" a la ligne " + vCpt );
          ...
          error( "[extends] Code source de "+pFil+" non analysable : " + pE + " (line " + vCpt + ")" );
        } // t/c
    } // verifExtendsDebug(...)
...
//         final String vSauf = ".*"+"\\LETTREouCHIFFRE+"+pAtt+".*";
        ...
        try {
          while ( vJ.hasNextLine() ) {
              ...
              if ( vL.matches( vAvec ) && vL.matches( vSans ) ) {
                sRetour = null;
                failIfNot( "A $a $n de quel objet veut-on acceder a la ligne " + vCpt + " ?" );
              } // if bad
          } // while
        } catch( Exception pE ) {
          error( "[AttThis] Code source de "+pFil+" non analysable : " + pE + " (line " + vCpt + ")" );
        } // t/c
    } // verifAttThisDebug(....)
...
//         final String vSauf = ".*"+"\\LETTREouCHIFFRE+"+pAtt+".*";
        ...
        try {
          ...
          error( "[MetThis] Code source de "+pFil+" non analysable : " + pE + " (line " + vCpt + ")" );
        } // t/c
    } // verifMetThisDebug(.....)
...
//        final String vSans = ".*"   +"\\s+"+pMet+"\\(.*";
        ...
        try {
          ...
          if ( vCount < pN ) {
            sRetour = null;
            error( "Vous n'utilisez pas suffisamment " + pTarget + " : " 
                   + vCount + " fois / " + pN + " attendues." );
          } // if not enough
          else if ( pN<0 && vCount>0 ) {
            sRetour = null;
            error( "Vous ne devez pas utiliser " + pTarget + " : "
                   + vCount + " fois / 0 attendue." );
          } // if not enough
        } catch( Exception pE ) {
          error( "[Count] Code source de "+pFil+" non analysable : " + pE + " (line " + vCpt + ")" );
        } // t/c
    } // verifCountDebug(.....)
    ...
    { // attention : ne marche pas si attribut cite dans commentaires
        ...
        try {
          ...
          error( "[ThisPar] Code source de "+pFil+" non analysable : " + pE + " (line " + vCpt + ")" );
        } // t/c
    } // verifThisParDebug(...)
...
//               if ( ! vL.matches( ".*\\p{Alpha}\\s+"+pMet+"\\s*\\(\\s*final\\s+\\p{Alpha}.*" ) )
    ...
    {        
        ...
        try {
          ...
          error( "[hasCo] Code source de "+pFil+" non analysable : " + pE + " (line " + vCpt + ")" );
        } // t/c
        return false;
    } // hasCoDebug(....)
